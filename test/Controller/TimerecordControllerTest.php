<?php
/**
 * TimerecordControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Timerecord Module
 *
 * @category Test
 * @package Timerecord
...
namespace OnePlaceTest\Timerecord\Controller;

use OnePlace\Timerecord\Controller\TimerecordController;
...
class TimerecordControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/timerecord', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('timerecord');
        $this->assertControllerName(TimerecordController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TimerecordController');
        $this->assertMatchedRouteName('timerecord');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/timerecord/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('timerecord');
        $this->assertControllerName(TimerecordController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TimerecordController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/timerecord/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('timerecord');
        $this->assertControllerName(TimerecordController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TimerecordController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/timerecord/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('timerecord');
        $this->assertControllerName(TimerecordController::class); // as specified in router's controller name alias
        $this->assertControllerClass('TimerecordController');
