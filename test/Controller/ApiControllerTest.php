...
use OnePlace\Timerecord\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/timerecord/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/timerecord/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('timerecord-api');
    }
}
