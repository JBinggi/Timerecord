<?php
/**
 * Timerecord.php - Timerecord Entity
 *
 * Entity Model for Timerecord
 *
 * @category Model
 * @package Timerecord
...
class Timerecord extends CoreEntityModel {
    public $label;
    ...
    public function exchangeArray(array $aData) {
        $this->id = !empty($aData['Timerecord_ID']) ? $aData['Timerecord_ID'] : 0;
